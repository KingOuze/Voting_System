...
?>
    ...
    <div class="row my-3">
        <div class="col-12">
            ...
            <?php 
                $fetchingActiveElections = mysqli_query($db, "SELECT * FROM elections WHERE status = 'start'") or die(mysqli_error($db));
                        ...
                        <table class="table">
                            ...
                            <?php 
                                ...
                                while($candidateData = mysqli_fetch_assoc($fetchingCandidates))
                                {
                                    ...
                                    $fetchingUser = mysqli_fetch_assoc($fetchingActiveUser);
                                    $candidate_nom = $fetchingUser['nom'];
                                    $candidate_prenom = $fetchingUser['prenom'];
                                    $candidate_photo = $fetchingUser['user_photo'];
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $candidate_prenom ; ?></td>
                                        <td><?php echo $candidate_nom; ?></td>
                ...
                <?php
                    ...
                    echo "<strong class=\"bg bg-primary\">No any active election.</strong>";
                }
            ?>
