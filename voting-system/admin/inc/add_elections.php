    ...
    <div class="col-4">
        ...
        <form method="POST">
            <div class="form-group">
                <input type="text" name="election_topic" placeholder="Type d'Election" class="form-control" required />
            </div>
            <div class="form-group">
                <input type="number" name="number_of_candidates" placeholder="Nombre de Candidat" class="form-control" value="" required />
            </div>
            <div class="form-group">
                <input type="text" onfocus="this.type='Date'" name="starting_date" placeholder="Date de Début" class="form-control" required />
            </div>
            <div class="form-group">
                <input type="text" onfocus="this.type='Date'" name="ending_date" placeholder="Date de Fin" class="form-control" required />
            </div>
            <input type="submit" value="Valider" name="addElectionBtn" class="btn btn-success" />
        </form>
    </div>
...
<?php 
    ...
    if(isset($_POST['addElectionBtn']))
    {
        ...
        $difrStart = strftime($start);
        $difrEnd = strftime($end);

        if ($difrEnd > $difrStart) {
            # code...
        ...
        ?>
           <script>
                alert("La date de Fin doit etre superieur au date de Debut");
           </script>
    <?php  
        }   
    ?>
